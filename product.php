        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                <button class="rounded-circle border-0" id="sidebarToggle"></button>
                    ...
                    <div>
                    <a href="manage_product.php">Add product</a><br><br>
                    ...
                    <?php
                        ...
                        while($row=mysqli_fetch_assoc($res)) {
                            ...
                            <td><img style="width: 50px;height:50px;" src=<?php echo PRODUCT_IMAGE_SITE_PATH.$row['image']?> alt=""></td>
                         ...
                         echo "<span class='p-2 bg-secondary'><a class='text-light' href='manage_product.php?id=".$row['categories_id']."'>Edit</a></span>&nbsp;&nbsp;";
